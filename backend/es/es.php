...
$__LANG = array (
	...
	'invalid_sessionid' => 'La sesión ha caducado por inactividad',
	...
	'name' => 'Nombre',
	'value' => 'Valor',
	'engagevisitor' => 'Captar al visitante',
...
if ($_SWIFT->Interface->GetInterface() == SWIFT_Interface::INTERFACE_ADMIN)
{
	...
	*/
	...
	$_adminBarContainer = array (
		...
		21 => array ('Biblioteca', 'bar_knowledgebase.gif', MODULE_KNOWLEDGEBASE),
	...
	*/
	...
	$_staffMenuContainer = array (
		...
		4 => array ('Biblioteca', 140, MODULE_KNOWLEDGEBASE, 'kb_entab'),
		5 => array ('Descargas', 110, MODULE_DOWNLOADS, 'dl_entab'),
		6 => array ('Asistente', 140, MODULE_TROUBLESHOOTER, 'tr_entab'),
	...
	*/
	$_staffLinkContainer = array (
		...
		4 => array (
				0 => array ('Ver biblioteca', '/Knowledgebase/ViewKnowledgebase/Index'),
				1 => array ('Administrar biblioteca', '/Knowledgebase/Article/Manage'),
		...
		6 => array (
				0 => array ('Ver asistente', '/Troubleshooter/Category/ViewAll'),
				1 => array ('Administrar asistente', '/Troubleshooter/Step/Manage'),
